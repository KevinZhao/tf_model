class Classifier_Pondering_BasicLSTM_L3(object):
    ...
    def __init__(self, 
        ...
        DeepLSTMCell = DeepRNN([lstm_1, lstm_2, lstm_3]) 
        act_core = DeepLSTMCell
        ...
        tf.nn.dynamic_rnn(cell=self._controller, 
                          inputs=self._inputs, 
